	...
	this.ini=function(){
		...
		$('.comp-consultor-elemento').each(function(){
			...
			var estructura='';
				...
				obj.LISTA[$(this).data('elemento')]=new OBJ_CONSULTOR_ELEMENTO('#comp-consultor-'+$(this).data('elemento'),$(this).data('conteo'),$(this).data('elemento'),estructura);
...
function OBJ_CONSULTOR_ELEMENTO(id,conteo,elemento,estructura){
...
/*
		...
		for(var campo in this.datos[id_elemento]){
			...
			if($('.comp-gestion-elemento[data-elemento="'+this.elemento+'"] .comp-ge-campo-data[data-campo="'+campo+'"]').data('esimagen')=='si'){
		        ...
		        var nodo_img='<div class="comp-ge-imagen" style="background-image: url('+src_imagen+'/'+this.datos[id_elemento][campo]+');" data-origen="bd" ></div>';
