		...
		$('.comp-visor-fotos').each(function(){
			...
			if(!$(obj_dom).data('inicializado')){
		        ...
		        if($(obj_dom).data('botones')==true){
		        	...
		        	html_botones_nav=
		        	'<div class="comp-vf-btn comp-vf-btn-ant '+array_class_extra['comp-vf-btn-ant']+'" data-idvf="#comp-visor-fotos-'+obj_ini.CONT_VISORES+'" data-idfoto="0" onmousedown="return false"  oncontextmenu="return false" ondragstart="return false"  onselectstart="return false"><div class="comp-vf-btn-flecha"></div></div>'+
			      	'<div class="comp-vf-btn comp-vf-btn-sig '+array_class_extra['comp-vf-btn-sig']+'" data-idvf="#comp-visor-fotos-'+obj_ini.CONT_VISORES+'" data-idfoto="2" onmousedown="return false"  oncontextmenu="return false" ondragstart="return false"  onselectstart="return false"><div class="comp-vf-btn-flecha"></div></div>';
		        }
