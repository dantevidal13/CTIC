				...
				////////////////////////////////////////////////////////////////////////
                	...
                	switch($(this).data('tipo')){
						...
						case 'imagen':
							...
							html_campos+='<div class="comp-ge-campo comp-ge-campo-data comp-ge-campo_input '+array_class_extra['comp-ge-campo']+'" data-src="'+src_imagen+'" data-campo="'+$(this).data('campo')+'" style="width:'+width+'%;" data-esimagen="si">'+
									html_nombre+
							...
							campos_form+='<input type="text" name="eliminar-imagen-'+$(this).data('campo')+'" value="">';
...
/*id="comp-ge-form-subir_imagen"*/
                ...
                switch(gestion){
                	case 'todo':
                          ...
                          '<div class="comp-ge-btn-accion" data-accion="update" data-idcomp="'+obj.CONT+'">'+
                            '<div class="content-btn">'+
                            	'<div class="comp-ge-boton">'+
		                          'Guardar Cambios'+
		                        '</div>'+
                          ...
                          '<div class="comp-ge-btn-accion" data-accion="delete" data-idcomp="'+obj.CONT+'">'+
                            '<div class="content-btn">'+
                            	'<div class="comp-ge-boton">'+
							...
							if(data.error){
								...
								switch(data.detalle){
									...
									case 'duplicado':
										...
										$('.comp-ge-campo[data-campo="'+data.campo+'"] .aviso-aux').html('Valor duplicado. Escriba otro valor para este campo.');
